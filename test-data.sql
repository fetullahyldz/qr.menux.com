...
VALUES
(1, 'Köfte', 'İzgara köfte, yanında pilav ve salata ile', 85.00, 'https://via.placeholder.com/150?text=Köfte', 1, 1),
(1, 'Tavuk Şiş', 'Özel marine edilmiş tavuk şiş', 75.00, 'https://via.placeholder.com/150?text=Tavuk+Şiş', 1, 2),
(2, 'Ayran', 'Ev yapımı ayran', 15.00, 'https://via.placeholder.com/150?text=Ayran', 1, 1),
(2, 'Çay', 'Demli çay', 10.00, 'https://via.placeholder.com/150?text=Çay', 1, 2),
(3, 'Baklava', 'Fıstıklı baklava', 45.00, 'https://via.placeholder.com/150?text=Baklava', 1, 1),
(3, 'Sütlaç', 'Ev yapımı fırın sütlaç', 35.00, 'https://via.placeholder.com/150?text=Sütlaç', 1, 2),
(4, 'Mercimek Çorbası', 'Geleneksel mercimek çorbası', 30.00, 'https://via.placeholder.com/150?text=Mercimek', 1, 1),
(4, 'Ezogelin Çorbası', 'Ezogelin çorbası', 30.00, 'https://via.placeholder.com/150?text=Ezogelin', 1, 2);
