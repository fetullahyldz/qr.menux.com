  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <h1 className="text-2xl font-bold">Garson Çağrıları</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="ml-2 inline-flex items-center rounded-md bg-gray-100 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200"
      ...
      {loading ? (
        ...
        <div className="flex h-48 flex-col items-center justify-center rounded-lg border border-gray-200 bg-gray-50 p-8 text-center">
          ...
          <p className="text-lg font-medium text-gray-900">Garson çağrısı bulunamadı</p>
