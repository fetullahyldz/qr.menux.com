...
import { Popover, PopoverContent, PopoverTrigger } from './ui/popover'; // Popover importu, shadcn-ui yerine doğru yolu kullanın
import { Button } from './ui/button'; // button.tsx dosyasından Button bileşeni
import { Check, ChevronDown, Globe } from 'lucide-react'; // lucide-react ikonu
...
export default function LanguageSwitcher({
  ...
  // Eğer diller yoksa veya sadece bir dil varsa, switcher gösterme
